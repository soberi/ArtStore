...
// // code to allow mobile collapsed nav to close when user 
// // clicks outside of element


// // need to fix so that when user clicks inside of search field the menu will not close
...
$(document).on('turbolinks:load ajaxSuccess', function(){
	...
	//for elevate zoom function
	$('.img-zoom').elevateZoom({
		//scrollZoom : true, **zoom does not relocate if browser window is resized with a page reload**
		zoomType: "lens",
		lensShape: "round",
		lensSize: 350,
